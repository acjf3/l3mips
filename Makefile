...
${L3SRCDIR}/cheri/%.spec: ${L3SRCDIR}/cheri/%.spec.m4
	m4 -I ${L3SRCDIR}/cheri/ -D CAP=$(CAP) -D L2SIZE=$(L2SIZE) -D L2WAYS=$(L2WAYS) -D L2LINESIZE=$(L2LINESIZE) -D L1ISIZE=$(L1ISIZE) -D L1IWAYS=$(L1IWAYS) -D L1DSIZE=$(LI1DSIZE) -D L1DWAYS=$(L1DWAYS) -D L1LINESIZE=$(L1LINESIZE) $^ > $@
