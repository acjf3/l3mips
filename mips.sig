...
val PIC_base_address_rupd: PIC * BitsN.nbit -> PIC
val PIC_config_regs_rupd: PIC * (PIC_Config_Reg Map.map) -> PIC
val PIC_external_intrs_rupd: PIC * BitsN.nbit -> PIC
val PIC_ip_bits_rupd: PIC * BitsN.nbit -> PIC
val PIC_mips_ip_bits_rupd: PIC * BitsN.nbit -> PIC
...
val write'reg'PIC_Config_Reg:
  (PIC_Config_Reg * BitsN.nbit) -> PIC_Config_Reg
val PIC_update: unit -> unit
val PIC_initialise: Nat.nat -> unit
val PIC_load: BitsN.nbit -> BitsN.nbit
val PIC_store: (BitsN.nbit * (BitsN.nbit * BitsN.nbit)) -> unit
