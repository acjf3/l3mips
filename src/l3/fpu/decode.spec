...
instruction COP1Decode (v::bits(26)) =
    ...
    (
        match v
        {
            ...
            case '01000 cc 00 i'              => BC1F(i, cc)
            case '01000 cc 01 i'              => BC1T(i, cc)
            case '01000 cc 10 i'              => BC1FL(i, cc)
            case '01000 cc 11 i'              => BC1TL(i, cc)
            ...
            case '10000 ft fs cc 0011 0 cnd'  => C_cond_S(fs, ft, cnd, cc)
            ...
            case '10001 ft fs cc 0011 0 cnd'  => C_cond_D(fs, ft, cnd, cc)
