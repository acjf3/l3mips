...
bool special_register_accessible (sel::bits(5)) = match sel
{
    ...
    case 22 => (CP0.Status.CU0 or KernelMode) and getPerms(PCC).Access_System_Registers
    case 23 => (CP0.Status.CU0 or KernelMode) and getPerms(PCC).Access_System_Registers
