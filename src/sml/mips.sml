(* mips - generated by L<3> - Mon Nov 10 16:58:52 2014 *)
...
type CP0 =
  { BadVAddr: BitsN.nbit, Cause: CauseRegister, Compare: BitsN.nbit,
    ...
    Debug: BitsN.nbit, EInstr: BitsN.nbit, EPC: BitsN.nbit,
    EntryHi: EntryHi, EntryLo0: EntryLo, EntryLo1: EntryLo,
    ErrCtl: BitsN.nbit, ErrorEPC: BitsN.nbit, HWREna: HWREna,
    Index: Index, LLAddr: BitsN.nbit, PRId: BitsN.nbit,
    PageMask: PageMask, Random: Random, Status: StatusRegister,
    UsrLocal: BitsN.nbit, Wired: Wired, XContext: XContext }
...
fun CP0_BadVAddr_rupd ({BadVAddr, Cause, Compare, Config, Config1,
   Config2, Config3, Config6, Context, Count, Debug, EInstr, EPC, EntryHi,
  ...
  {BadVAddr = x', Cause = Cause, Compare = Compare, Config = Config,
   ...
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0

fun CP0_Cause_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
   Config3, Config6, Context, Count, Debug, EInstr, EPC, EntryHi,
   EntryLo0, EntryLo1, ErrCtl, ErrorEPC, HWREna, Index, LLAddr, PRId,
   PageMask, Random, Status, UsrLocal, Wired, XContext}: CP0, x') =
...
fun CP0_Config1_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   Context = Context, Count = Count, Debug = Debug, EInstr = EInstr,
...
fun CP0_EInstr_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
   Config3, Config6, Context, Count, Debug, EInstr, EPC, EntryHi,
   EntryLo0, EntryLo1, ErrCtl, ErrorEPC, HWREna, Index, LLAddr, PRId,
   PageMask, Random, Status, UsrLocal, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Config2 = Config2, Config3 = Config3,
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = x', EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_EPC_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Config2 = Config2, Config3 = Config3,
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = x', EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_EntryHi_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Config2 = Config2, Config3 = Config3,
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = x', EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_EntryLo0_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Config2 = Config2, Config3 = Config3,
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = x',
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_EntryLo1_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = x', ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, HWREna = HWREna,
   Index = Index, LLAddr = LLAddr, PRId = PRId, PageMask = PageMask,
   Random = Random, Status = Status, UsrLocal = UsrLocal, Wired = Wired,
   XContext = XContext}: CP0
...
fun CP0_ErrCtl_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = x', ErrorEPC = ErrorEPC, HWREna = HWREna,
   Index = Index, LLAddr = LLAddr, PRId = PRId, PageMask = PageMask,
   Random = Random, Status = Status, UsrLocal = UsrLocal, Wired = Wired,
   XContext = XContext}: CP0
...
fun CP0_ErrorEPC_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = x', HWREna = HWREna,
   Index = Index, LLAddr = LLAddr, PRId = PRId, PageMask = PageMask,
   Random = Random, Status = Status, UsrLocal = UsrLocal, Wired = Wired,
   XContext = XContext}: CP0
...
fun CP0_HWREna_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   Config6 = Config6, Context = Context, Count = Count, Debug = Debug,
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, HWREna = x',
   Index = Index, LLAddr = LLAddr, PRId = PRId, PageMask = PageMask,
   Random = Random, Status = Status, UsrLocal = UsrLocal, Wired = Wired,
   XContext = XContext}: CP0
...
fun CP0_Index_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = x', LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_LLAddr_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = x', PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_PRId_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EInstr = EInstr, EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0,
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = x',
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = XContext}: CP0
...
fun CP0_PageMask_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = x', Random = Random, Status = Status, UsrLocal = UsrLocal,
...
fun CP0_Random_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = x', Status = Status, UsrLocal = UsrLocal,
   Wired = Wired, XContext = XContext}: CP0
...
fun CP0_Status_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = x', UsrLocal = UsrLocal,
   Wired = Wired, XContext = XContext}: CP0
...
fun CP0_UsrLocal_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EntryLo1 = EntryLo1, ErrCtl = ErrCtl, ErrorEPC = ErrorEPC,
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status, UsrLocal = x',
   Wired = Wired, XContext = XContext}: CP0
...
fun CP0_Wired_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = x', XContext = XContext}: CP0
...
fun CP0_XContext_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   HWREna = HWREna, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status,
   UsrLocal = UsrLocal, Wired = Wired, XContext = x'}: CP0
  ...
  (Map.mkMap
     (SOME 256,
      {BadVAddr = BitsN.B(0x0,64),
       ...
       Debug = BitsN.B(0x0,32), EInstr = BitsN.B(0x0,32),
       EPC = BitsN.B(0x0,64),
       EntryHi =
...
val currentInst = ref (NONE): (BitsN.nbit option) ref
...
fun CheckBranch () =
  if Option.isSome(BranchDelay ())
    then raise UNPREDICTABLE ("Not permitted in delay slot")
  else ();
...
fun SignalException ExceptionType =
  ...
  ; let
    ...
    in
      ( if Option.isSome (!currentInst)
          then let
                 val x = CP0 ()
               in
                 write'CP0(CP0_EInstr_rupd(x,Option.valOf (!currentInst)))
               end
        else ()
      ; let
          val x = CP0 ()
...
fun dfn'ERET () =
  ...
  ; if ((#CU0)((#Status)(CP0 ()))) orelse (KernelMode ())
      then ( if (#ERL)((#Status)(CP0 ()))
               then ( write'PC
                        (BitsN.-((#ErrorEPC)(CP0 ()),BitsN.B(0x4,64)))
                    ; let
                        val x = CP0 ()
                        val x0 = (#Status) x
                      in
...
fun CPR (n,(reg,sel)) =
  case (n,(reg,sel)) of
   ...
   | (0,(BitsN.B(0x8,5),BitsN.B(0x1,3))) =>
        BitsN.fromNat(BitsN.toNat((#EInstr)(CP0 ())),64)
...
fun dfn'JALR (rs,rd) =
  ...
  in
    ...
    ; write'BranchTo(Option.SOME temp)
    )
  end;
...
fun dfn'SC (base,(rt,offset)) =
  case LLbit () of
   ...
   | Option.SOME true =>
        if (BitsN.bits((#LLAddr)(CP0 ()),39,5)) =
           (BitsN.bits(BitsN.+(BitsN.signExtend 64 offset,GPR base),39,5))
          then ( storeWord(base,(rt,offset))
               ; write'LLbit NONE
               ; write'GPR(BitsN.B(0x1,64),rt)
               )
        else raise UNPREDICTABLE
               ("SC: address does not match previous LL address");
...
fun dfn'SCD (base,(rt,offset)) =
  case LLbit () of
   ...
   | Option.SOME true =>
        if (BitsN.bits((#LLAddr)(CP0 ()),39,5)) =
           (BitsN.bits(BitsN.+(BitsN.signExtend 64 offset,GPR base),39,5))
          then ( storeDoubleword(base,(rt,offset))
               ; write'LLbit NONE
               ; write'GPR(BitsN.B(0x1,64),rt)
               )
        else raise UNPREDICTABLE
               ("SCD: address does not match previous LL address");
...
fun dfn'JR rs = write'BranchTo(Option.SOME(GPR rs));
    ...
    then write'BranchTo
           (Option.SOME
              (BitsN.+
                 (BitsN.+(PC (),BitsN.B(0x4,64)),
                  BitsN.<<(BitsN.signExtend 64 offset,2))))
  else ( CheckBranch (); write'PC(BitsN.+(PC (),BitsN.B(0x4,64))) );
