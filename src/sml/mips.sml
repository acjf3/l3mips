<<<<<<< HEAD
(* mips - generated by L<3> - Thu Oct 16 14:13:58 2014 *)
=======
<<<<<<< HEAD
(* mips - generated by L<3> - Wed Oct 15 16:05:29 2014 *)
=======
(* mips - generated by L<3> - Sat Oct 11 18:24:06 2014 *)
>>>>>>> Factoring out a cleaner memeory interface to experiment with caches
>>>>>>> Factoring out a cleaner memeory interface to experiment with caches
...
fun log_w_hi data = ("HI <- 0x") ^ (BitsN.toHexString data);

fun log_w_lo data = ("LO <- 0x") ^ (BitsN.toHexString data);

fun log_w_c0 (r,data) =
  String.concat[cpr r," <- 0x",BitsN.toHexString data];

fun log_w_mem (pAddr,(mask,(sz,data))) =
  String.concat
...
fun ReadData pAddr = Map.lookup((!MEM),BitsN.toNat pAddr);
    ...
    in
      ...
      ; if not(exceptionSignalled ())
          then let
               ...
               in
                 ( mark_log
                     (2,log_w_mem((!pAddr),(mask,(AccessLength,MemElem))))
                 ; let
                     val found = ref false
                   in
                     ( if a = ((#base_address) (!JTAG_UART))
