...
val currentInst: (BitsN.nbit option) ref
val done: bool ref
val instCnt: Nat.nat ref
val log: (string list Map.map) ref
val print: (string -> unit) ref
val println: (string -> unit) ref
...
val StatusRegister_CU2_rupd: StatusRegister * bool -> StatusRegister
val StatusRegister_CU3_rupd: StatusRegister * bool -> StatusRegister
...
val CP0_EInstr_rupd: CP0 * BitsN.nbit -> CP0
...
val log_sig_exception: BitsN.nbit -> string
val log_w_gpr: (BitsN.nbit * BitsN.nbit) -> string
val log_w_hi: BitsN.nbit -> string
val log_w_lo: BitsN.nbit -> string
val log_w_c0: (BitsN.nbit * BitsN.nbit) -> string
val log_w_mem: (BitsN.nbit * (BitsN.nbit * BitsN.nbit)) -> string
val log_r_mem: (BitsN.nbit * BitsN.nbit) -> string
val mark_log: (Nat.nat * string) -> unit
val unmark_log: Nat.nat -> unit
...
val SignalCP2UnusableException: unit -> unit
...
val InitMEM: unit -> unit
val ReadData: BitsN.nbit -> BitsN.nbit
val WriteData: (BitsN.nbit * (BitsN.nbit * BitsN.nbit)) -> unit
val ReadInst: BitsN.nbit -> BitsN.nbit
val LoadMemory:
