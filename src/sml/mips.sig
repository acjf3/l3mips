...
val sig_exception: BitsN.nbit -> string
val w_gpr: (BitsN.nbit * BitsN.nbit) -> string
val w_hi: BitsN.nbit -> string
val w_lo: BitsN.nbit -> string
val w_c0: (BitsN.nbit * BitsN.nbit) -> string
val w_mem:
  (BitsN.nbit * (BitsN.nbit * (BitsN.nbit * BitsN.nbit))) -> string
val mark: (Nat.nat * string) -> unit
val unmark: Nat.nat -> unit
