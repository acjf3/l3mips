...
val c_BranchDelay: ((BitsN.nbit option) option Map.map) ref
val c_BranchTo: ((bool * BitsN.nbit) option Map.map) ref
...
val BranchDelay: unit -> ((BitsN.nbit option) option)
val write'BranchDelay: ((BitsN.nbit option) option) -> unit
val BranchTo: unit -> ((bool * BitsN.nbit) option)
val write'BranchTo: ((bool * BitsN.nbit) option) -> unit
