(* mips - generated by L<3> - Thu Jul 24 09:52:07 2014 *)
...
fun dfn'TLBWI () =
  if (not((#CU0)((#Status) (!CP0)))) andalso (not(KernelMode ()))
    ...
    then raise UNPREDICTABLE ("TLBWI: index > TLBEntries - 1")
  else let
...
fun dfn'TLBWR () =
  if (not((#CU0)((#Status) (!CP0)))) andalso (not(KernelMode ()))
    then SignalException CpU
         ...
         val r = BitsN.fromNat(BitsN.toNat((#Random)((#Random) (!CP0))),4)
       in
         TLB_assoc :=
         (Map.update
            ((!TLB_assoc),BitsN.toNat r,
             ModifyTLB(Map.lookup((!TLB_assoc),BitsN.toNat r))))
       end;
...
fun initMips (pc,uart) =
  ...
  ; let
    ...
    in
      ...
      (CP0_Config6_rupd
         ((!CP0),
          ConfigRegister6_TLBSize_rupd
            (x0,BitsN.fromNat(Nat.-(TLBEntries,1),16))))
    end
  ; let
      val x0 = (#Config6) (!CP0)
    in
