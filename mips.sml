(* mips - generated by L<3> - Tue Jul 15 20:08:39 2014 *)
...
type CP0 =
  { BadVAddr: BitsN.nbit, Cause: CauseRegister, Compare: BitsN.nbit,
    ...
    ErrorEPC: BitsN.nbit, Index: Index, LLAddr: BitsN.nbit,
    PRId: BitsN.nbit, PageMask: PageMask, Random: Random,
    Status: StatusRegister, Wired: Wired, XContext: XContext }
...
fun CP0_BadVAddr_rupd ({BadVAddr, Cause, Compare, Config, Config1,
   ...
   EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index, LLAddr, PRId, PageMask,
   Random, Status, Wired, XContext}: CP0, x') =
...
fun CP0_Cause_rupd ({BadVAddr, Cause, Compare, Config, Config1, Config2,
   ...
   EntryLo1, ErrCtl, ErrorEPC, Index, LLAddr, PRId, PageMask, Random,
   Status, Wired, XContext}: CP0, x') =
     ...
     | (0,(BitsN.B(0x6,5),BitsN.B(0x0,3))) =>
          ( let
            ...
            in
              CP0 :=
              (CP0_Wired_rupd
                 ((!CP0),Wired_Wired_rupd(x0,BitsN.bits(value,5,0))))
            end
          ; let
              val x0 = (#Random) (!CP0)
            in
              ...
              (CP0_Random_rupd
                 ((!CP0),
                  Random_Random_rupd
                    (x0,BitsN.fromNat(Nat.-(TLBEntries,1),6))))
            end
          )
     | (0,(BitsN.B(0x9,5),BitsN.B(0x0,3))) =>
...
fun initMips (pc,uart) =
  ...
  ; let
    ...
    in
      ...
      (CP0_Random_rupd
         ((!CP0),
          Random_Random_rupd(x0,BitsN.fromNat(Nat.-(TLBEntries,1),6))))
    end
  ; let
      val x0 = (#Wired) (!CP0)
    in
      CP0 := (CP0_Wired_rupd((!CP0),Wired_Wired_rupd(x0,BitsN.B(0x0,6))))
    end
