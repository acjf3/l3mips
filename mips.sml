(* mips - generated by L<3> - Tue Jul 15 15:18:33 2014 *)
...
type CP0 =
  { BadVAddr: BitsN.nbit, Cause: CauseRegister, Compare: BitsN.nbit,
    Config: ConfigRegister, Config1: ConfigRegister1, Context: Context,
    Count: BitsN.nbit, Debug: BitsN.nbit, EPC: BitsN.nbit,
    EntryHi: EntryHi, EntryLo0: EntryLo, EntryLo1: EntryLo,
    ErrCtl: BitsN.nbit, ErrorEPC: BitsN.nbit, Index: Index,
    LLAddr: BitsN.nbit, PRId: BitsN.nbit, PageMask: PageMask,
    Random: Random, Status: StatusRegister, Wired: Wired,
    XContext: XContext }
...
fun CP0_BadVAddr_rupd ({BadVAddr, Cause, Compare, Config, Config1,
   Context, Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl,
   ErrorEPC, Index, LLAddr, PRId, PageMask, Random, Status, Wired,
   XContext}: CP0, x') =
  {BadVAddr = x', Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Cause_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
...
fun CP0_Compare_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
...
fun CP0_Config_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
...
fun CP0_Config1_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = x', Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Context_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = x', Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Count_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = x', Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Debug_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = x',
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_EPC_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
...
fun CP0_EntryHi_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
...
fun CP0_ErrCtl_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = x', ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0
...
fun CP0_ErrorEPC_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = x', Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Index_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = x', LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_LLAddr_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Config1 = Config1, Context = Context, Count = Count, Debug = Debug,
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = x',
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_PRId_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = x', PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0
...
fun CP0_PageMask_rupd ({BadVAddr, Cause, Compare, Config, Config1,
  ...
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = x', Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Random_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = x', Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Status_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   ...
   EPC = EPC, EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = x',
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Wired_rupd ({BadVAddr, Cause, Compare, Config, Config1, Context,
   Count, Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC,
   Index, LLAddr, PRId, PageMask, Random, Status, Wired, XContext}
  : CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
  ...
  ({BadVAddr = BitsN.B(0x0,64),
    ...
    Status =
      {BEV = false, CU0 = false, ERL = false, EXL = false, FR = false,
       ...
       statusregister'rst = BitsN.B(0x0,12)},
...
fun JTAG_UART_initialise uart =
  ...
  ; let
    ...
    in
      JTAG_UART :=
      (JTAG_UART_control_rupd
         ((!JTAG_UART),JTAG_UART_control_RE_rupd(x0,false)))
    end
  ; let
      val x0 = (#control) (!JTAG_UART)
    in
...
fun JTAG_UART_write_mm () =
  let
    val x = (#base_address) (!JTAG_UART)
  in
    MEM :=
    (Map.update
       ((!MEM),BitsN.toNat x,
        BitsN.@@
          (flip_endian(reg'JTAG_UART_data((#data) (!JTAG_UART))),
           flip_endian(reg'JTAG_UART_control((#control) (!JTAG_UART))))))
  end;

fun LoadMemory (CCA,(AccessLength,(pAddr,(vAddr,IorD)))) =
  let
    val a = BitsN.bits(pAddr,39,3)
    val d = Map.lookup((!MEM),BitsN.toNat a)
  in
    ( if (a = ((#base_address) (!JTAG_UART))) andalso
         ((BitsN.bits(pAddr,2,0)) = (BitsN.B(0x0,3)))
        then ( JTAG_UART_load (); JTAG_UART_write_mm () )
      else ()
    ; d
    )
  end;
...
fun StoreMemory (CCA,(AccessLength,(MemElem,(pAddr,(vAddr,IorD))))) =
  ...
  in
    ...
    ; if a = ((#base_address) (!JTAG_UART))
        then ( JTAG_UART_store(mask,MemElem); JTAG_UART_write_mm () )
      else MEM :=
           (Map.update
              ((!MEM),BitsN.toNat a,
               BitsN.||
        ...
        | [(i,e)] =>
           (if ((#G) e) orelse
              ...
              then ( let
                     ...
                     in
                       CP0 :=
                       (CP0_Index_rupd((!CP0),Index_P_rupd(x0,false)))
                     end
                   ; let
                       val x0 = (#Index) (!CP0)
                     in
                       CP0 :=
                       (CP0_Index_rupd((!CP0),Index_Index_rupd(x0,i)))
                     end
                   )
            else let
                   val x0 = (#Index) (!CP0)
              ...
              in
                ( let
                  ...
                  in
                    CP0 :=
                    (CP0_PageMask_rupd
                       ((!CP0),PageMask_Mask_rupd(x0,(#Mask) e)))
                  end
                ; let
                    val x0 = (#EntryHi) (!CP0)
                  in
                    CP0 :=
                    (CP0_EntryHi_rupd((!CP0),EntryHi_R_rupd(x0,(#R) e)))
                  end
                ; let
                    val x0 = (#EntryHi) (!CP0)
                  in
                    CP0 :=
                    (CP0_EntryHi_rupd
                       ((!CP0),EntryHi_VPN2_rupd(x0,(#VPN2) e)))
                  end
                ; let
                    val x0 = (#EntryHi) (!CP0)
                  in
                    CP0 :=
                    (CP0_EntryHi_rupd
                       ((!CP0),EntryHi_ASID_rupd(x0,(#ASID) e)))
                  end
                ; let
                    val x0 = (#EntryLo1) (!CP0)
                  in
                    CP0 :=
                    (CP0_EntryLo1_rupd
                       ((!CP0),EntryLo_PFN_rupd(x0,(#PFN1) e)))
                  end
                ; let
                    val x0 = (#EntryLo1) (!CP0)
                  in
                ...
                ; let
                  ...
                  in
                    CP0 :=
                    (CP0_EntryLo0_rupd
                       ((!CP0),EntryLo_PFN_rupd(x0,(#PFN0) e)))
                  end
                ; let
                    val x0 = (#EntryLo0) (!CP0)
                  in
...
fun Fetch () =
  ...
  ; if ((#IE)((#Status) (!CP0))) andalso
       (not(((#EXL)((#Status) (!CP0))) orelse ((#ERL)((#Status) (!CP0)))))
      then if (BitsN.bit((#IM)((#Status) (!CP0)),7)) andalso
              (((#Compare) (!CP0)) = ((#Count) (!CP0)))
             then ( let
                      val x0 = (#Cause) (!CP0)
                    in
                      CP0 :=
                      (CP0_Cause_rupd
                         ((!CP0),CauseRegister_TI_rupd(x0,true)))
                    end
                  ; let
                      val x0 = (#Cause) (!CP0)
                      val w = (#IP) x0
                          ...
                          CauseRegister_IP_rupd
                            (x0,
                             BitsN.bitFieldInsert
                               (w,BitsN.fromBit true,7,7))))
                    end
                  ; SignalException Int
                  )
           else if (((BitsN.bit((#IM)((#Status) (!CP0)),2)) andalso
                ((#WE)((#control) (!JTAG_UART)))) andalso
               (not((#WI)((#control) (!JTAG_UART))))) andalso
              (Nat.<=
                 ((#write_threshold) (!JTAG_UART),
                  BitsN.toNat((#WSPACE)((#control) (!JTAG_UART)))))
             then ( let
                      val x0 = (#control) (!JTAG_UART)
                    in
                      JTAG_UART :=
                      (JTAG_UART_control_rupd
                         ((!JTAG_UART),JTAG_UART_control_WI_rupd(x0,true)))
                    end
                  ; JTAG_UART_write_mm ()
                  ; let
                      val x0 = (#Cause) (!CP0)
                      ...
                      (CP0_Cause_rupd
                         ((!CP0),
                          CauseRegister_IP_rupd
                            (x0,
                             BitsN.bitFieldInsert
                               (w,BitsN.fromBit true,2,2))))
                    end
                  ; SignalException Int
                  )
           else if (((BitsN.bit((#IM)((#Status) (!CP0)),2)) andalso
                ((#RE)((#control) (!JTAG_UART)))) andalso
               (not((#RI)((#control) (!JTAG_UART))))) andalso
              (Nat.<=
                 ((#read_threshold) (!JTAG_UART),
                  BitsN.toNat((#RAVAIL)((#data) (!JTAG_UART)))))
             then ( let
                      val x0 = (#control) (!JTAG_UART)
                    in
                      JTAG_UART :=
                      (JTAG_UART_control_rupd
                         ((!JTAG_UART),JTAG_UART_control_RI_rupd(x0,true)))
                    end
                  ; JTAG_UART_write_mm ()
                  ; let
                      val x0 = (#Cause) (!CP0)
...
fun initMips (pc,uart) =
  ...
  ; let
      val x0 = (#Config1) (!CP0)
    in
      CP0 := (CP0_Config1_rupd((!CP0),ConfigRegister1_M_rupd(x0,false)))
    end
  ; let
      val x0 = (#Config1) (!CP0)
    in
  ...
  ; let
      val x0 = (#Wired) (!CP0)
    in
      CP0 := (CP0_Wired_rupd((!CP0),Wired_Wired_rupd(x0,BitsN.B(0x1,6))))
    end
  ...
  ; addTLB
      (BitsN.@@
         (BitsN.fromNat(BitsN.toNat((#base_address) (!JTAG_UART)),61),
          BitsN.B(0x0,3)),BitsN.B(0x0,4))
  ; JTAG_UART_write_mm ()
  );
