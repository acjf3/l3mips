(* mips - generated by L<3> - Thu Jul 10 10:35:57 2014 *)
...
type CP0 =
  { BadVAddr: BitsN.nbit, Cause: CauseRegister, Compare: BitsN.nbit,
    Config: ConfigRegister, Context: Context, Count: BitsN.nbit,
...
fun CP0_BadVAddr_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
...
fun CP0_Cause_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
...
fun CP0_Compare_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
...
fun CP0_Config_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
...
fun CP0_Context_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = x', Count = Count, Debug = Debug, EPC = EPC,
   EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Count_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = x', Debug = Debug, EPC = EPC,
   EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_Debug_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = x', EPC = EPC,
   EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_EPC_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = x',
   EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_EntryHi_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
   EntryHi = x', EntryLo0 = EntryLo0, EntryLo1 = EntryLo1,
   ErrCtl = ErrCtl, ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr,
   PRId = PRId, PageMask = PageMask, Random = Random, Status = Status,
   Wired = Wired, XContext = XContext}: CP0

fun CP0_EntryLo0_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
   EntryHi = EntryHi, EntryLo0 = x', EntryLo1 = EntryLo1, ErrCtl = ErrCtl,
...
fun CP0_EntryLo1_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
   EntryHi = EntryHi, EntryLo0 = EntryLo0, EntryLo1 = x', ErrCtl = ErrCtl,
   ErrorEPC = ErrorEPC, Index = Index, LLAddr = LLAddr, PRId = PRId,
   PageMask = PageMask, Random = Random, Status = Status, Wired = Wired,
   XContext = XContext}: CP0

fun CP0_ErrCtl_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_ErrorEPC_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_Index_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_LLAddr_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_PRId_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_PageMask_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_Random_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_Status_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_Wired_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
...
fun CP0_XContext_rupd ({BadVAddr, Cause, Compare, Config, Context, Count,
   Debug, EPC, EntryHi, EntryLo0, EntryLo1, ErrCtl, ErrorEPC, Index,
   LLAddr, PRId, PageMask, Random, Status, Wired, XContext}: CP0, x') =
  {BadVAddr = BadVAddr, Cause = Cause, Compare = Compare, Config = Config,
   Context = Context, Count = Count, Debug = Debug, EPC = EPC,
  ...
  ({BadVAddr = BitsN.B(0x0,64),
    ...
    Config =
      {BE = false, K0 = BitsN.B(0x0,3), MT = BitsN.B(0x0,3),
       configregister'rst = BitsN.B(0x0,25)},
    Context =
...
fun JTAG_UART_store (mask,MemElem) =
  ( if not((BitsN.bits(mask,63,56)) = (BitsN.B(0x0,8)))
      then ( let
               val x0 = (#data) (!JTAG_UART)
             in
               JTAG_UART :=
               (JTAG_UART_data_rupd
                  ((!JTAG_UART),
                   JTAG_UART_data_RW_DATA_rupd
                     (x0,BitsN.bits(MemElem,63,56))))
             end
           ; let
               val x0 = (#data) (!JTAG_UART)
             in
           ...
           ; if not(((#WSPACE)((#control) (!JTAG_UART))) =
                    (BitsN.B(0x0,16)))
               then ( let
                        val x0 = (#control) (!JTAG_UART)
                      in
