(* mips - generated by L<3> - Wed Apr 23 15:58:44 2014 *)
    ...
    in
      ...
      in
        ( if ((a = ((#base_address) (!JTAG_UART))) andalso (Nat.<(b,4))) andalso
            ...
            then ( if (#RVALID)((#data) (!JTAG_UART))
                     then d :=
                          (BitsN.||
                             (BitsN.&&
                                ((!d),BitsN.B(0xFFFFFF00FFFFFFFF,64)),
                              BitsN.<<
                                (BitsN.fromNat
                                   (BitsN.toNat
...
fun Fetch () =
  ...
  ; if (((#IE)((#Status) (!CP0))) andalso
        (BitsN.bit((#IM)((#Status) (!CP0)),7))) andalso
    ...
    else if (((((#IE)((#Status) (!CP0))) andalso
          (BitsN.bit((#IM)((#Status) (!CP0)),2))) andalso
           ...
           ; let
             ...
             in
               ...
               (CP0_Cause_rupd
                  ((!CP0),
                   CauseRegister_IP_rupd
                     (x0,BitsN.bitFieldInsert(w,BitsN.fromBit true,2,2))))
             end
           ; SignalException Int
           ; NONE
           )
